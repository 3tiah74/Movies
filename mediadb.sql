...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 17, 2026 at 11:52 AM
...
--
-- Constraints for table `movietrailers`
--
ALTER TABLE `movietrailers`
  ADD CONSTRAINT `movietrailers_ibfk_1` FOREIGN KEY (`movie_id`) REFERENCES `movies` (`movie_id`);
